...
const ErrorPage = () => {
  return (
    <div>
      <main className="flex dark:bg-slate-800 flex-col w-full select-none h-[100vh] gap-5 items-center justify-center">
        <h1 className="bg-clip-text text-transparent  bg-gradient-to-r from-cyan-500 to-blue-500 text-[20vw] font-bold">
          Oops!
        </h1>
        <h2 className="sm:text-[3vw] font-medium dark:text-slate-50">
          404 - PAGE NOT FOUND
        </h2>
        <p></p>
